 ...
 * @property array $json
 *
 * @Routes(name_prefix="api_projects_issuetypes_", url_prefix="/api/v1/projects/:project_id")
 */
class IssueTypes extends ProjectNamespacedController
{
     ...
     *
     * @Route(name="list", url="/issuetypes")
     ...
     * List all project's issue fields
     *
     * @Route(name="get", url="/issuetypes/:issuetype")
     * @param framework\Request $request
     */
